...
public class MCreatorGameCubeCreeper extends Elementscreepers_exspanded.ModElement {
	public static final int ENTITYID = 5;
	public static final int ENTITYID_RANGED = 6;

	public MCreatorGameCubeCreeper(Elementscreepers_exspanded instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("creepers_exspanded", "gamecubecreeper"), ENTITYID).name("gamecubecreeper").tracker(64, 1, true)
				.egg(-6750055, -3355444).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCreeper(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("creepers_exspanded:textures/gamecube.png");
				}
			};
		});
	}
	...
	public static class EntityCustom extends EntityCreeper {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
					"creepers_exspanded:gamecubestartup"));
		}
