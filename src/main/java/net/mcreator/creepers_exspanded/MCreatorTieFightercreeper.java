...
public class MCreatorTieFightercreeper extends Elementscreepers_exspanded.ModElement {
	public static final int ENTITYID = 7;
	public static final int ENTITYID_RANGED = 8;

	public MCreatorTieFightercreeper(Elementscreepers_exspanded instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("creepers_exspanded", "tiefightercreeper"), ENTITYID).name("tiefightercreeper").tracker(64, 1, true)
				.egg(-1, -1).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCreeper(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("creepers_exspanded:textures/tiefighter.png");
				}
			};
		});
	}
